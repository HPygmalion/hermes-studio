    ...
    <div class="sidebar-footer">
      ...
      <div class="version-info">
        <div class="version-links">
          <a class="github-link" href="https://github.com/HPygmalion/hermes-studio" target="_blank" rel="noopener noreferrer" title="GitHub">
          ...
          <a class="website-link" href="https://github.com/HPygmalion/hermes-studio/releases/tag/lts" target="_blank" rel="noopener noreferrer" title="Releases">
